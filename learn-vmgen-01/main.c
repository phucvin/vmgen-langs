...
int main(int argc, char **argv)
{
  ...
  if (code == 0) {
    ...
    gen_set_rl(&vmcodep, 9, (long int)(char *)start + 56);
    ...
    gen_jump_l_if_r_lt_l(&vmcodep, (Cell *)((char *)start + 368), 0, 2);
    // recursive case
    ...
    gen_set_rl(&vmcodep, 9, (long int)(char *)start + 232);
    gen_jump_l(&vmcodep, (Cell *)((char *)start + 72));
