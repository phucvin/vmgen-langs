...
{
  "$end", "error", "$undefined", "halt", "num", "frame", "push", "label",
  "jump_lt", "add", "sub", "call", "ret", "alloc", "store", "load", "':'",
  "$accept", "program", "inst", YY_NULLPTR
};
#endif
...
{
       2,     0,     1,     7,     0,     0,     0,    14,    16,     0,
       9,     0,     0,     0,     3,    11,     4,    13,     0,     0,
       0,    10,     8,    19,    20,     0,    15,    17,    18,    12
};
...
#line 1364 "y.tab.c"
  ...
  case 8:
#line 43 "parser.y"
                { gen_alloc(&vmcodep, (yyvsp[0].long_val)); }
#line 1370 "y.tab.c"
    break;
...
#line 1394 "y.tab.c"
  ...
  case 13:
#line 48 "parser.y"
                    { gen_jump_lt(&vmcodep, 0); insert_jump((yyvsp[0].string_val), vmcodep - 1); }
#line 1400 "y.tab.c"
    break;
